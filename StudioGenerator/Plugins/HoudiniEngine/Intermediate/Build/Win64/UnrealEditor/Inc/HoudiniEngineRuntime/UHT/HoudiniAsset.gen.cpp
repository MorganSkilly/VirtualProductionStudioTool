...
#if WITH_EDITORONLY_DATA
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniAsset_Statics::NewProp_AssetImportData = { "AssetImportData", nullptr, (EPropertyFlags)0x01160008000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniAsset, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AssetImportData_MetaData), NewProp_AssetImportData_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniAsset_Statics::NewProp_HoudiniToolData = { "HoudiniToolData", nullptr, (EPropertyFlags)0x01160008000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniAsset, HoudiniToolData), Z_Construct_UClass_UHoudiniToolData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HoudiniToolData_MetaData), NewProp_HoudiniToolData_MetaData) };
#endif // WITH_EDITORONLY_DATA
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniAsset_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniAsset, UHoudiniAsset::StaticClass, TEXT("UHoudiniAsset"), &Z_Registration_Info_UClass_UHoudiniAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniAsset), 2339881601U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniAsset_h_1622029126(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Public_HoudiniAsset_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
