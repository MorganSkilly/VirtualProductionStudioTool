...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniParameterString_Statics::NewProp_ChosenAssets_Inner = { "ChosenAssets", nullptr, (EPropertyFlags)0x0104000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniParameterString_Statics::NewProp_ChosenAssets = { "ChosenAssets", nullptr, (EPropertyFlags)0x0124080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniParameterString, ChosenAssets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ChosenAssets_MetaData), NewProp_ChosenAssets_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterString, UHoudiniParameterString::StaticClass, TEXT("UHoudiniParameterString"), &Z_Registration_Info_UClass_UHoudiniParameterString, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterString), 4194023464U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h_1447352627(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
