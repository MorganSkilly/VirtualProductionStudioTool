...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniParameterFolderList_Statics::NewProp_TabFolders = { "TabFolders", nullptr, (EPropertyFlags)0x0114008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniParameterFolderList, TabFolders), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TabFolders_MetaData), NewProp_TabFolders_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolderList_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterFolderList, UHoudiniParameterFolderList::StaticClass, TEXT("UHoudiniParameterFolderList"), &Z_Registration_Info_UClass_UHoudiniParameterFolderList, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterFolderList), 2528988127U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolderList_h_3627917059(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolderList_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StudioGenerator_Plugins_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolderList_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
